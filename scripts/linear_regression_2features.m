...
load('updrs.mat')
z=parkinsonsupdrs;    % data matrix
[NT,F]=size(z);            % number oc rows and columns
Npatients=max(z(:,1)); % number of subjects
ntrain=36;
%
% data preparation
%
[ Ntimes,w_prep, data_train_norm, data_test_norm ] = data_prep_norm( ntrain,Npatients,z );
%
% MMSE regression
%
